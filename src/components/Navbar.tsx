...
export function Navbar(toggleSidebar: () => void, isSidebarOpen: boolean, handleSidebarItemClick: (id: string) => void) {
  return <nav
  ...
  >
    ...
    <ul
      className={`${isSidebarOpen
        ...
        : "max-h-0 opacity-0 transition-all duration-1000 ease-in-out"} overflow-hidden text-sky-50 ml-4`}
    >
